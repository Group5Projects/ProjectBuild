...
class Story {
        ...
        if (subprogress == 0) {
            ...
            if (location.contains("chase")) {
                ...
                if (subsubprogress == 0) {
                    ...
                    String choice2 = "Shoot him";
                    String choice3 = "Let him get away";
                    String choice4 = "Check Inventory";

                    gc.getJFX().updateChoices("c2Lady chase tackle", choice1, "c2Lady chase shoot", choice2, "c2Lady chase getAway", choice3, "c2Lady chase check", choice4);
        ...
        if (subprogress == 0) {
            ...
            if (location.contains("steal")) {
                ...
                if (subsubprogress == 0) {
                    ...
                    gc.getJFX().updateChoices("c3WalkCalmly giveBack pistol", choice1, "c3WalkCalmly giveBack tackle", choice2, "c3WalkCalmly giveBack dropWallet", choice3, "c3WalkCalmly giveBack check", choice4);
    ...
    public void c4Approach(String location) {
        ...
        if (subprogress == 0) {
            ...
            String choice2 = "Use pistol to shoot";
            String choice3 = "Hand to hand combat only";
            String choice4 = "Check Inventory";
            
            gc.getJFX().updateChoices("c4Approach knife", choice1, "c4Approach pistol", choice2, "c4Approach handToHand", choice3, "c4Approach check", choice4);
    ...
    public void c4BenchPeople(String location) {
        ...
        if (subprogress == 0) {
            ...
            String choice3 = "Sell pistol for $100";
            String choice4 = "Check Inventory";
            
            gc.getJFX().updateChoices("c4BenchPeople medkit", choice1, "c4BenchPeople knife", choice2, "c4BenchPeople pistol", choice3, "c4BenchPeople check", choice4);
